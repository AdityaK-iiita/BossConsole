...
SELECT ok(
    NOT has_table_privilege('anon', 'public.default_privilege_guard_table', 'ALL'),
    'anon has no default ALL privilege on new tables'
);

SELECT ok(
    NOT has_table_privilege('authenticated', 'public.default_privilege_guard_table', 'ALL'),
...
SELECT ok(
    ...
    'anon has no default ALL privilege on new sequences'
);
...
SELECT ok(
    ...
    'authenticated has no default ALL privilege on new sequences'
);
...
SELECT ok(
    ...
    'anon has no default ALL privilege on new functions'
);
...
SELECT ok(
    ...
    'authenticated has no default ALL privilege on new functions'
);
